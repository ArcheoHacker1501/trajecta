...
> [!IMPORTANT]
> - To install the latest version of Trajecta (v1.0.0) [download the installer (Trajecta-1.0.0.exe)](https://github.com/ArcheoHacker1501/trajecta/releases/tag/v1.0.0) and click on it once the download is done. Then follow the instructions on the screen.
